                ...
                @auth
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        @else
                            ...
                            <a href="{{ route('chat.index') }}" class="nav-link-hover px-4 py-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-all-smooth font-medium">
                                <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @auth
                <div id="mobileMenu" class="hidden md:hidden border-t border-white border-opacity-20 pt-4 pb-4 mobile-menu-slide">
                    ...
                    @else
                        ...
                        <a href="{{ route('chat.index') }}" class="block px-4 py-3 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-all-smooth">AI Assistant</a>
                    @endif
                </div>
            @endauth
        </nav>
