...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Available Rooms</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-2">Browse and view details of all available rooms for booking.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="p-6">
                        ...
                        @if($room->about)
                            <div class="mb-4">
                                ...
                                <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{{ $room->about }}</p>
                            </div>
                        @endif
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        ...
                                        @if(count($equipmentList) > $displayCount)
                                            <button onclick="toggleEquipment({{ $room->id }})" 
                                                    class="inline-block bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs px-2 py-1 rounded-full hover:bg-blue-200 dark:hover:bg-blue-800 transition-colors cursor-pointer">
                                    ...
                                    @if(count($equipmentList) > $displayCount)
                                        <div id="equipment-{{ $room->id }}" class="hidden">
                                            <div class="border-t dark:border-gray-700 pt-2 mt-2">
                                                <p class="text-xs text-gray-500 dark:text-gray-400 mb-2 font-medium">Complete Equipment List:</p>
                                                <div class="grid grid-cols-1 gap-1">
                                                    @foreach($equipmentList as $index => $item)
                                                        <div class="flex items-center text-sm text-gray-700 dark:text-gray-300">
                                                            <svg class="w-3 h-3 mr-2 text-green-500 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @else
                            <div class="mb-6">
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-sm italic">No equipment information available</p>
                            </div>
                        @endif
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Contact admin to add rooms for booking.</p>
                </div>
            @endforelse
        </div>
