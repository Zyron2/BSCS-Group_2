    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                ...
                <div class="px-6 py-8 border-b border-gray-200">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p id="selectedFileName" class="text-sm text-blue-600 mt-1 font-medium"></p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Action Buttons -->
                <div class="px-6 py-6 bg-gray-50 flex justify-between">
                    <a href="{{ route('dashboard') }}" 
                       class="bg-gray-600 text-white px-6 py-2 rounded-lg hover:bg-gray-700 transition duration-200 font-medium">
                        Cancel
                    </a>
                    <button type="submit" 
