...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">Manage your room bookings and reservations.</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="flex flex-col space-y-2 ml-6">
                            ...
                            @else
                                @if($bookingDateTime->isPast())
                                    <span class="text-gray-500 text-sm italic">Past booking</span>
                                @elseif($booking->status === 'rejected')
                                    <span class="text-red-500 text-sm italic">Rejected</span>
                                @endif
                            @endif
            ...
            @empty
                <div class="p-12 text-center">
                    ...
                    <p class="text-gray-500 mb-6">You haven't made any room bookings yet.</p>
