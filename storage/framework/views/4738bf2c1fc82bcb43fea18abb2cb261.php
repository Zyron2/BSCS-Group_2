        ...
        <nav class="container mx-auto px-4 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div class="hidden md:flex items-center space-x-1">
                        <?php if(auth()->user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-link-hover px-4 py-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-all-smooth font-medium">
                                <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                                </svg>
                                Dashboard
                            </a>
                            <a href="<?php echo e(route('admin.rooms')); ?>" class="nav-link-hover px-4 py-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-all-smooth font-medium">
                                <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                </svg>
                                Rooms
                            </a>
                            <a href="<?php echo e(route('admin.bookings')); ?>" class="nav-link-hover px-4 py-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-all-smooth font-medium">
                                <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="nav-link-hover px-4 py-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-all-smooth font-medium">
                                <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="<?php echo e(route('rooms.index')); ?>" class="nav-link-hover px-4 py-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-all-smooth font-medium">
                                <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                </svg>
                                Rooms
                            </a>
                            <a href="<?php echo e(route('bookings.index')); ?>" class="nav-link-hover px-4 py-2 text-white hover:bg-white hover:bg-opacity-20 rounded-lg transition-all-smooth font-medium">
                                <svg class="w-4 h-4 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="button"
                                ...
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div class="hidden sm:block text-left">
                                        ...
                                        <p class="text-blue-100 text-xs capitalize"><?php echo e(auth()->user()->role ?? 'User'); ?></p>
                                    </div>
                                </div>
                            ...
                            <div id="profileDropdown"
                                ...
                                <div class="bg-gradient-to-br from-blue-500 via-purple-600 to-indigo-600 px-6 py-5 relative overflow-hidden">
                                    ...
                                    <div class="flex items-center space-x-4 relative z-10">
                                        ...
                                        <div class="flex-1">
                                            <h3 class="text-white font-bold text-lg"><?php echo e(auth()->user()->name); ?></h3>
                                            <p class="text-blue-100 text-sm opacity-90"><?php echo e(auth()->user()->email); ?></p>
                                            <div class="flex items-center mt-1">
                                                <div class="w-2 h-2 bg-green-400 rounded-full mr-2 animate-pulse"></div>
                                                <span class="text-white text-xs opacity-75 capitalize"><?php echo e(auth()->user()->role ?? 'User'); ?> • Online</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <?php else: ?>
                    <!-- Guest Navigation -->
                    <div class="flex items-center space-x-4">
                        <a href="<?php echo e(route('login')); ?>" class="text-white hover:text-blue-100 font-medium transition-colors duration-200">
                            Sign In
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="bg-white text-blue-600 px-6 py-2 rounded-lg font-medium hover:bg-blue-50 transition-all-smooth shadow-md hover:shadow-lg hover:scale-105">
                            Get Started
                        </a>
                    </div>
                <?php endif; ?>
            ...
            <?php if(auth()->guard()->check()): ?>
                <div id="mobileMenu" class="hidden md:hidden border-t border-white border-opacity-20 pt-4 pb-4 mobile-menu-slide">
                    <?php if(auth()->user()->role === 'admin'): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-3 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-all-smooth">Dashboard</a>
                        <a href="<?php echo e(route('admin.rooms')); ?>" class="block px-4 py-3 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-all-smooth">Manage Rooms</a>
                        <a href="<?php echo e(route('admin.bookings')); ?>" class="block px-4 py-3 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-all-smooth">Manage Bookings</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="block px-4 py-3 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-all-smooth">Dashboard</a>
                        <a href="<?php echo e(route('rooms.index')); ?>" class="block px-4 py-3 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-all-smooth">View Rooms</a>
                        <a href="<?php echo e(route('bookings.index')); ?>" class="block px-4 py-3 text-white hover:bg-white hover:bg-opacity-10 rounded-lg transition-all-smooth">My Bookings</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        </nav>
...
<?php /**PATH C:\Users\HP Elitebook\Group2Laravel\BSCS-Group_2\resources\views/layouts/app.blade.php ENDPATH**/ ?>